...
- 来源: c:\Users\29530\Desktop\DM\vulhub\gitea\1.4-rce\README.zh-cn.md
- Vulhub 相对路径: gitea/1.4-rce/README.zh-cn.md
- 脱敏代码块: 1
...
环境启动后，访问`http://your-ip:3000`，将进入安装页面，填写管理员账号密码，并修改网站URL，其他的用默认配置安装即可。（不要修改端口号）
