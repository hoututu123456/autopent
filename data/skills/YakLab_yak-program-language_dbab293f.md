# 任意用户密码重置 | Yak Program Language

- 来源: https://www.yaklang.com/Yaklab/wiki/AnyUserPasswordReset
...
有些重置密码过程中会发送一个密码重置链接，例如： www.xxx.com/repass?token=aaa 如果密码重置链接中的token或者其他字段存在一定的规律，攻击者通过爆破可以获得其他用户的token
...
邮箱中收到一个密码重置链接
例如： https://xxxx.xxx.xxx.xx/index/index/resetpass/code/280938b01d7742de39dbdd7tfffe2453bfaf4c48 像这种类似的密码重置链接如果验证凭证存在一定规律可以尝试进行猜解，从而重置其他用户密码
