# 插件概述：定义与基础类型 | Yak Program Language

- 来源: https://www.yaklang.com/products/Plugin-repository/plugins/plugin_type
...
- 常见插件类型 原理分类：独立模块与嵌入模块
- 典型应用分类 Yak 原生模块 MITM 原生模块
- 总结
