# 03.GET 参数是 JSON，JSON 中字段存在 SQL 注入 | Yak Program Language

- 来源: https://www.yaklang.com/Yaklab/vulinbox/SQLi/03unsafe-id-json/
...
/*URL地址*/
http:
//127.0.0.1:8787/user/id-json?id={"uid":1,"id":"1"}
/*原SQL语句*/
select
