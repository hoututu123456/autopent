# 序列场景案例：每日签到 | Yak Program Language

- 来源: https://www.yaklang.com/products/Web%20Fuzzer/fuzz-sequence-example1/
...
- 使用获取到的nonce值（继承变量和cookie），其中第三个请求使用到第二个请求的变量： {{p(nonce)}}
