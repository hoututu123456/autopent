# 热加载场景案例：csrf token保护下的爆破 | Yak Program Language

- 来源: https://www.yaklang.com/products/Web%20Fuzzer/fuzz-hotpatch-example1/
...
HTTP
(
`GET /vul/burteforce/bf_token.php HTTP/1.1
...
- 通过响应拿到Set-Cookie的值
- 通过xpath语法获取token的值
- 替换 __TOKEN__ 为实际的token
- 添加POST请求的Cookie为第二步中拿到的Set-Cookie，这样模拟了多个用户同时请求的情况
