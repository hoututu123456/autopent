# 11. 文件过滤：检测文件内容 | SSA.to

- 来源: https://ssa.to/syntaxflow-guide/statements/sf_file_filter
- 抓取时间: 2026-02-06T07:30:27Z
...
- 文件过滤简介
- 语法规则
- 具体案例解析 1. 使用正则表达式过滤文件内容 2. 使用 JSONPath 过滤文件内容 3. 使用 XPath 过滤 XML 文件内容
- 使用Xpath提取Json和Yaml文件内容 1. 使用 XPath 过滤 JSON 文件内容 2. 使用 XPath 过滤 YAML 文件内容
- 实战中注意事项
